...
export function WorldMap({
  ...
  const initialFillColors: Partial<Record<string, string>> = {
    AE: color,
    AF: color,
    AL: color,
    AM: color,
  ...
  const [fillColors, setFillColors] =
    useState<Partial<Record<string, string>>>(initialFillColors);
